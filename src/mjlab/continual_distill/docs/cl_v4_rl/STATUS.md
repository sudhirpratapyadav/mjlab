...
Checked 2026-09-12. **10/24 certified: Reach, Topple, Button, Drawer, Drag, Flip, Door, Push-Cuboid, Flap and Lever.** Retained checkpoints/normalizers/configurations, strict results and reviewed videos are in W&B. Seven runs now occupy GPUs1–7: Lift, Reorient, Axial, Lid, Cage, Valve and Window respectively. GPU0 remains unused. See certificate JSONs, scoreboard and training_wave4/5 manifests. Edge/Pivot/Stack/Place/Peg/Strike/Throw still need first-pilot readiness.
...
|---|---:|---|---|---|---|
| Axial-Extract | 4 | off | Training first pilot | Not measured | mechanism_v1, GPU3; unchanged extraction predicate. |
...
| Slide-Window | 3 | off | Training first pilot | Not measured | mechanism_v1, GPU7; preflight passed. |
