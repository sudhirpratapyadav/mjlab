...
| RL-001 | Reach | First full training/evaluation pilot; baseline physics and reward | 1,024 envs, 500 iterations, seed20260912, GPU2 | Complete | model_499.pt: 128/128 validation seed20260914, 128/128 confirmation seed20260915; strict first-episode evaluator; both timeout at full horizon; W&B training sync and eval artifact uploaded to initial entity, relocation pending |
...
| RL-002-R1 | Lift | Complete interrupted baseline pilot from its own model_300 | 1,024 envs, 200 additional updates, seed20260912, GPU1 | Prepared | Restore policy/optimizer/normalizers; fresh environment/RNG; online W&B verified |
| RL-004-R1 | Drag-Pull | Complete interrupted baseline pilot from its own model_300 | 1,024 envs, 200 additional updates, seed20260912, GPU4 | Prepared | Restore policy/optimizer/normalizers; fresh environment/RNG; online W&B verified |
| RL-005-R1 | Reorient | Complete interrupted baseline pilot from its own model_300 | 1,024 envs, 200 additional updates, seed20260912, GPU5 | Prepared | Restore policy/optimizer/normalizers; fresh environment/RNG; online W&B verified |
| RL-006-R1 | Topple | Complete interrupted baseline pilot from its own model_200 | 1,024 envs, 300 additional updates, seed20260912, GPU6 | Prepared | Restore policy/optimizer/normalizers; fresh environment/RNG; online W&B verified |
