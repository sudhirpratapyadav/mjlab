...
See evidence/*-certificate.json, training_wave21.json, gyro_compatibility_audit.json and rl_training_coverage.json. Verify Slurm/process state before GPU reuse.
