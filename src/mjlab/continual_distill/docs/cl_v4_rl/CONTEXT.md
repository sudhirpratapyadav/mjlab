...
See evidence/*-certificate.json, training_wave18.json, gyro_compatibility_audit.json and rl_training_coverage.json. Verify Slurm/process state before GPU reuse.
