...
from .env_cfgs import (
  ...
  unitree_go1_flat_proprio_env_cfg,
...
register_mjlab_task(
  task_id="Mjlab-Velocity-Flat-Unitree-Go1-Proprio",
  env_cfg=unitree_go1_flat_proprio_env_cfg(),
  play_env_cfg=unitree_go1_flat_proprio_env_cfg(play=True),
  rl_cfg=unitree_go1_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
