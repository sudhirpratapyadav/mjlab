...
from mjlab.tasks.manipulation.mdp import PlaceInContainerCommandCfg
...
def make_place_in_container_env_cfg() -> ManagerBasedRlEnvCfg:
  """Place a carried object inside an open-top container (containment success shape).
  ...
  policy_terms = {
    ...
    "object_to_goal": ObservationTermCfg(
      ...
      params={
        "command_name": "place_in_container",
        "object_asset_name": "cube",
      },
      noise=Unoise(n_min=-0.01, n_max=0.01),
    ),
  ...
  commands: dict[str, CommandTermCfg] = {
    "place_in_container": PlaceInContainerCommandCfg(
      asset_name="cube",
      robot_asset_cfg=SceneEntityCfg("robot", site_names=()),  # Set per-robot
