...
def make_reorient_object_env_cfg() -> ManagerBasedRlEnvCfg:
  """Reorient an object in place to a target axis (orientation success shape).
  ...
  policy_terms = {
    ...
    "object_pos": ObservationTermCfg(
      ...
      params={"object_asset_name": "cylinder"},
      noise=Unoise(n_min=-0.01, n_max=0.01),
    ),
  ...
  commands: dict[str, CommandTermCfg] = {
    "reorient_object": ReorientObjectCommandCfg(
      asset_name="cylinder",
      robot_asset_cfg=SceneEntityCfg("robot", site_names=()),  # Set per-robot
