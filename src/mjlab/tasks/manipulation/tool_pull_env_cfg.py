...
from mjlab.tasks.manipulation.mdp import ToolPullCommandCfg
...
def make_tool_pull_env_cfg() -> ManagerBasedRlEnvCfg:
  """Drag an out-of-reach puck into the near zone with a grasped stick (tool use).
