...
def franka_stack_cube_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  # Stacking is a grasp-and-place task; same PPO recipe as lift-cube.
  cfg = franka_lift_cube_ppo_runner_cfg()
  cfg.experiment_name = "franka_stack_cube"
  return cfg
